        ...
        return (
            <div className="text-black font-cabin flex flex-col place-self-center pt-1 -mb-9">
                <div className="inline-flex place-items-center max-w-[47rem]">
                    ...
                    <h3
                        className="rounded-lg bg-off-white self-center p-5 shadow-lg shadow-blue/10 break-words text-center md:text-xl 2xl:text-2xl min-w-[30rem] max-w-[35rem] md:max-h-16 2xl:max-h-[15rem]"
...
IntentDiagram.propTypes = {
    ...
    isFlagged: PropTypes.bool = false,
    isStarred: PropTypes.bool = false,
}
