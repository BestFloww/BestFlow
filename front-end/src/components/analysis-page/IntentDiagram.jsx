            ...
            <div className="container mx-auto text-black font-cabin flex flex-col pt-1 gap-y-2">
                <div className="inline-flex place-self-center">
                    <button onClick={this.toggleStar} aria-label="star button">
                        <label>
                            <svg className={this.isStarred ? "w-16 m-3 fill-yellow cursor-pointer": "w-16 m-3 fill-transparent cursor-pointer"} viewBox="0 0 25 25" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button onClick={this.toggleFlag} aria-label="flag-button">
                        <label>
                            <svg className={this.isFlagged ? "w-16 m-3 fill-red cursor-pointer": "w-16 m-3 fill-transparent cursor-pointer"} viewBox="0 0 512 512" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg">
